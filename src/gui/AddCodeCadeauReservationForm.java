 ...
 * @author mbembli
 */
public class AddCodeCadeauReservationForm extends Form{

    public AddCodeCadeauReservationForm() {
        this.setTitle("Add Gift Code");
        ...
        submitBtn.addActionListener((evt) -> {
            ...
            if (txtcode.getText().length() == 0 || txtprice.getText().length() == 0 ){
                ...
                try{
                   ...
                   if (new CodeCadeauReservationService().addCodeCadeauReservationAction(c).equals("success")){
                       Dialog.show("Success", "Gift code added successfully.", null, "Ok");
                   }
                   else if (new CodeCadeauReservationService().addCodeCadeauReservationAction(c).equals("existcode")){
                       Dialog.show("Alert", "Gift code already exist.", null, "Ok");
                   }
                }
